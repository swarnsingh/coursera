 ...
 * parameters needed. To aid the user we introduce {@link Hero.Builder} class. {@link Hero.Builder} takes
 * the minimum parameters to build {@link Hero} object in its constructor. After that additional
 * configuration for the {@link Hero} object can be done using the fluent {@link Hero.Builder} interface.
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        var warrior = new Hero.Builder(Profession.WARRIOR, "Amber jill")
